...
- `user_zshell.yml` defines the managed zsh login shell, `.zshrc`, aliases, and environment baseline enforced for the example human admin account when `user.yml` enables `user_zshell`.
